...
export class CartService {
  ...
  CheckoutFromCart(userId: number, payload: any) {
    payload.userId = userId;
    this.http.post(`${this.serverURL}/orders/payment`, payload).subscribe((res: { success: boolean }) => {
      console.log(res);
      if (res.success) {
  ...
  GetUserInfo(userId: number) {
    return this.http.get(`${this.serverURL}/users/${userId}/checkout`);
  }
}
